...
def calc_apostas(aposta1, aposta2, aposta3, odd1, odd2, odd3, mercado1, mercado2, mercado3, valor1, valor2, valor3, bethouse_options1, bethouse_options2, bethouse_options3, arred_var):
    ...
    if odd3 > 0.0:
        ...
        if (mercado1 == mercado2 and valor1 == valor2) or (mercado1 == mercado3 and valor1 == valor3) or (mercado2 == mercado3 and valor2 == valor3):
        ...
        elif (mercado2 == "1X" or mercado2 == "X2") and (mercado1.startswith('AH') and valor1 == 0.25 and (mercado3 == '1' or mercado3 == '2' or (mercado3.startswith('AH') and valor3 == -0.5))) or (mercado3.startswith('AH') and valor3 == 0.25 and (mercado1 == '1' or mercado1 == '2' or (mercado1.startswith('AH') and valor1 == -0.5))):
            ...
            return aposta1, aposta2, aposta3, None, lucro1, lucro2, lucro3, lucro_percent, None
                ...
                (all(mercado.startswith("T") for mercado in mercados) and (str(valor1).endswith('.75') and str(valor2).endswith('.5') and str(valor3).endswith('.5')) or (str(valor3).endswith('.75') and str(valor1).endswith('.5') and str(valor2).endswith('.5'))):
        ...
        elif mercado2 == 'X' and (mercado1.startswith('AH') and mercado3.startswith('AH') and ((valor1 == -0.25 and valor3 == 0) or (valor1 == 0 and valor3 == -0.25))):
            if aposta1 > 0 and aposta2 > 0 and aposta3 > 0:
                pass
            elif aposta1 > 0 and aposta2 > 0:
                aposta3 = round(((retorno1() + retorno2()) * 3 / 4) / arred_var) * arred_var
            elif aposta1 > 0 and aposta3 > 0:
                aposta2 = aposta1 / odd_2
